...
if (isset($_POST['submit'])) {
    ...
    // Save configuration options to the file "config_data.php".
    $configFile = __DIR__ . '/config_data.php';
    $configContent = "<?php\n";
    $configContent .= "// config_data.php\n";
    $configContent .= "// This file is automatically generated. Do not edit manually.\n";
    ...
    // Optionally include an additional header file.
